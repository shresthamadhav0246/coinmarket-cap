...
const CoinNameRow = ({ name, icon, clicked }) => {
    ...
    const coinIcon = () => {
        switch (name) {
            case "Bitcoin":
                return <Image src={btc} className="rounded-full" width={20} height={20} alt="" />
            ...
            case "Cardano":
                return (
                    <Image src={cardano} className="rounded-full" width={20} height={20} alt="" />
                )
            ...
            case "Solana":
                return (
                    <Image src={solana} className="rounded-full" width={20} height={20} alt="" />
                )
        ...
        <div className="flex items-center">
            ...
            <p>
                {name === "Bitcoin" || name === "Ethereum" || name === "Tether" ? (
                    <span
                        className="bg-[#1A1F3A] text-[#6188FF] p-1 px-3 text-sm rounded-lg cursor-pointer hover:opacity-50"
                        onClick={() => openModal()}
                    >
                        Buy
                    </span>
